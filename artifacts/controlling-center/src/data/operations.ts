...
export const EMPLOYEES: Employee[] = [
  ...
  { id: "E5", name: "Clara Hoffmann", avatar: "/avatars/clara.png", email: "c.hoffmann@lpo-group.com", entity: "COSM", department: "Management", position: "Geschäftsführerin", startDate: "2018-01-08", status: "Aktiv", location: "Düsseldorf", assignedDevices: ["COSM-FU-0007"], openReturns: 0 },
  { id: "E6", name: "Jonas Richter", avatar: "/avatars/maria.png", email: "j.richter@lpo-group.com", entity: "CPE", department: "Produktion", position: "Werkleiter", startDate: "2017-03-20", status: "Aktiv", location: "München", assignedDevices: ["CPE-VH-0005"], openReturns: 0 },
  { id: "E7", name: "Elena Vogt", avatar: "/avatars/sofia.png", email: "e.vogt@lpo-group.com", entity: "IMP", department: "Vertrieb", position: "Sales Lead", startDate: "2023-08-01", status: "Beurlaubt", location: "Hamburg", assignedDevices: [], openReturns: 0 },
];
